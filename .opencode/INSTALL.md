...
This is the fork at [github.com/chankh70/superpowers-plus](https://github.com/chankh70/superpowers-plus). For upstream Superpowers see [obra/superpowers](https://github.com/obra/superpowers).
...
```json
{
  "plugin": ["superpowers-plus@git+https://github.com/chankh70/superpowers-plus.git"]
}
```
...
OpenCode installs Superpowers Plus through a git-backed package spec. Some OpenCode
and Bun versions pin that resolved git dependency in a lockfile or cache, so a
restart may not pick up the newest Superpowers Plus commit. If updates do not
...
```json
{
  "plugin": ["superpowers-plus@git+https://github.com/chankh70/superpowers-plus.git#v5.0.3"]
}
```
...
```json
{
  "plugin": ["~/.config/opencode/node_modules/superpowers-plus"]
}
```
...
- Full documentation: https://github.com/chankh70/superpowers-plus/blob/main/docs/README.opencode.md
